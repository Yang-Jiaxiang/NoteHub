...
function MyName({user}){
    ...
    return(
        ...
        <Modal open={isModalOpen} size='mini'>
            ...
            <Modal.Content>
                <Input placeholder='修改新的會員名稱' value={displayName} onChange={(e)=>{
...
function MyPhoto({user}){
    ...
    function onSubmit(){
        setIsLoading(true)
        const fileRef=firebase.storage().ref('userphoto/'+user.uid)
        const metadata={
        ...
        <Modal open={isModalOpen} size='mini'>
            ...
            <Modal.Content image>
                ...
                <Modal.Description>
                    ...
                    <input type='file'id='post-image' style={{display:'none'}} onChange={(e)=>{
    ...
    return(
        ...
        <Modal open={isModalOpen} size='mini'>
            ...
            <Modal.Content>
                ...
                <Input placeholder='請輸入舊密碼' value={oldPassword} onChange={(e)=>{
                    setOldPassword(e.target.value)
                }} fluid/>
                <Header size='small'>新密碼</Header>
                <Input placeholder='請輸入新密碼' value={newPassword} onChange={(e)=>{
